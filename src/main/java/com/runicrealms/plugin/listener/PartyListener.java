...
public class PartyListener implements Listener {
    ...
    public void onPartyJoin(PartyJoinEvent event) {
        ...
        int slotLeader = RunicCore.getCharacterAPI().getCharacterSlot(event.getParty().getLeader().getUniqueId());
        int slotMember = RunicCore.getCharacterAPI().getCharacterSlot(event.getMember().getUniqueId());
